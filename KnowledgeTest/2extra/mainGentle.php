...
function anadirComentario($con, $nombre, $comentario, $fecha){
    ...
    $consulta = "INSERT INTO comentariosestilo(nombre, comentario, fecha) VALUES ('$nombre', '$comentario', '$fecha')";
...
function anadirComentarioCC($con, $nombre, $comentario, $fecha){

    // $consulta = "select * from grup where ID between 1 and 10";
    $consulta = "INSERT INTO comentarioscortecabello(nombre, comentario, fecha) VALUES ('$nombre', '$comentario', '$fecha')";
...
function mostrarComentarios($con){
    ...
    $consulta = "SELECT * FROM comentariosestilo";
...
function mostrarComentariosCC($con){

    $consulta = "SELECT * FROM comentarioscortecabello";
...
if( isset($_POST['functionToCall']) && !empty($_POST['functionToCall']) ){
    ...
    switch($functionToCall){
        ...
        case 'mostrarComentariosCC': 
            mostrarComentariosCC($conJS);
            break;

        case 'anadirComentarioCC': 
            $nombre = $_POST['nombre'];
            $comentario = $_POST['comentario'];
            $fecha = $_POST['fecha'];
            
            anadirComentarioCC($conJS, $nombre, $comentario, $fecha);
            break;
